...
#ifndef SHARINGCLIENTSERVICE_H
#define SHARINGCLIENTSERVICE_H
...
class ComIntelSharingServiceInterface;

class SharingClientService : public QObject
{
    Q_OBJECT
public:
    explicit SharingClientService(QString serviceName = QString(),
...
signals:
    void ServiceChanged(SharingClientService *);
...
private:
    ComIntelSharingServiceInterface *mServiceIntf;
...
Q_DECLARE_METATYPE(SharingClientService *)

#endif // SHARINGCLIENTSERVICE_H
