...
Item {
    ...
    property QtObject sharingObj: SharingClientQmlObj {
        id: sharingObj
        shareType: SharingClientQmlObj.ShareTypeImage
    }
...
//            ctxServices.show();
    ...
    function selectService(svcDispName, svcModel) {
        ...
        if (sharingObj.getCredsState() != SharingClientQmlObj.CredsStateValid) {
            console.log("Bad Creds for", svcDispName, ":", sharingObj.getCredsState(), ", should be", SharingClientQmlObj.CredsStateValid);
    ...
    SaveRestoreState {
        ...
        Component.onCompleted: {
            ...
            if (restoreRequired) {
                ...
                var val;
                val = mySnR.value(snrPrefix + "_shareType", SharingClientQmlObj.ShareTypeImage)
...
//            if (opid == dlgItem.shareID) {
  ...
  //          }
    ...
    Translator {
        catalog: "libsharingclient-qml-ui"
    }
