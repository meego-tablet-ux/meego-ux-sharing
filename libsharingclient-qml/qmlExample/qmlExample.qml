        ...
        Item {
            ...
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        sharingObj.shareType = SharingClientQmlObj.ShareTypeImage
            ...
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        sharingObj.shareType = SharingClientQmlObj.ShareTypeVideo
                        serviceTypeList.model = sharingObj.serviceTypes
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
                        sharingObj.shareType = SharingClientQmlObj.ShareTypeAudio
                        serviceTypeList.model = sharingObj.serviceTypes
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        sharingObj.shareType = SharingClientQmlObj.ShareTypeText
                        serviceTypeList.model = sharingObj.serviceTypes
                    }
                }
            }
            Rectangle {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        sharingObj.shareType = SharingClientQmlObj.ShareTypeVCard
                        serviceTypeList.model = sharingObj.serviceTypes
                    }
                }
            }
